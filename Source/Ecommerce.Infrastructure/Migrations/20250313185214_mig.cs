    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          EmailVerificationOtpNextResendValidAt = table.Column<DateTime>(
            type: "datetime2",
            nullable: true
          ),
          ...
          PasswordResetOtpNextResendValidAt = table.Column<DateTime>(
            type: "datetime2",
            nullable: true
          ),
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          BottomImage_ObjectIdentifier = table.Column<string>(
            type: "nvarchar(450)",
            nullable: true
          ),
        },
